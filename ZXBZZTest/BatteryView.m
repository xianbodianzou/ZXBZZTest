...
-(void)didMoveToSuperview{
    ...
    //电池图片重置。
    self.stateImage.image  = [UIImage imageNamed: [@"ZZBattery.bundle" stringByAppendingPathComponent:@"eQuantity"] inBundle:[NSBundle bundleForClass:[self class]] compatibleWithTraitCollection:nil];
    //通知注册
    //设置电池通知启动
